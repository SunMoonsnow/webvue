			...
			<div class="singer-details">
				...
				<div class="song-list">
					<div class="wrapper">
						<div class="content">
							<ul>
								<router-link :to="'/singer/' + song.musicData.songmid +'/'+ song.musicData.albummid" tag="div" v-for="(song,k) in singer.list" :key="song.musicData.songid" @click.native="setCurSong(song)">
									<li >
										<div class="info">
		...
		methods:{
			_getData(){//获取歌手详情信息
				...
				jsonp(url,{param:'jsonpCallback'},(err,data)=>{
					...
					//生成封面结构
					this.thumb=`<img src="https://y.gtimg.cn/music/photo_new/T001R300x300M000${this.singer.singer_mid}.jpg">`;
